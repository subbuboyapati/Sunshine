package com.subbu.sunshine.sync;
...
import com.subbu.sunshine.BuildConfig;
import com.subbu.sunshine.MainActivity;
import com.subbu.sunshine.R;
import com.subbu.sunshine.Utility;
...
// 60 seconds (1 minute) * 180 = 3 hours
    ...
    static private void setLocationStatus(Context context, @LocationStatus int locationStatus) {
        ...
        spe.putInt(context.getString(R.string.location_status), locationStatus);
        spe.commit();
    }
    ...
    private void notifyWeather() {
        ...
        boolean notification = prefs.getBoolean(context.getString(R.string.notification_key),
...
// mId allows you to update the notification later on.
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        String locationQuery = sharedPrefs.getString(context.getString(R.string.pref_location_key),
        ...
        try {
            ...
            e.printStackTrace();
            setLocationStatus(context, LOCATION_STATUS_SERVER_DOWN);
            Log.e(TAG, e + ", " + urlConnection.getURL().toString());
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            int status = forecastJson.getInt(OWM_MESSAGE_CODE);
            switch (status) {
            ...
            if (cVVector.size() > 0) {
                ...
                Object[] values = cVVector.toArray();
                ContentValues[] contentValues = new ContentValues[values.length];
                cVVector.toArray(contentValues);
                inserted = context.getContentResolver().bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI, contentValues);
                ...
                long yesterdayDate = WeatherContract.normalizeDate(cal.getTimeInMillis());
